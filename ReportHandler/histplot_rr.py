...
plt.xlabel('Rate of Return %', fontsize=30)

# Force gridlines parallel to x-axis to make bar values easier to read
plt.grid(b=True, which='both', axis='y')
plt.tick_params(axis='both', labelsize=18)
plt.tick_params(axis='y', pad=10)
plt.bar(bins, vals, color=colors, width=0.2, align='center')

plt.xticks( bins, ('-100', '-80', '-60', '-40', '-20',
  '0', '20', '40', '60', '80', '100'), rotation=60 )
